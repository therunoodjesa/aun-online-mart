...
export default function CartPage() {
  ...
  return <View style={styles.screen}>
    ...
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      {serviceFee > 0 && <View style={{ marginBottom: 14, borderRadius: 8, padding: 12, backgroundColor: '#E1F5EE', flexDirection: 'row', justifyContent: 'space-between' }}><Text style={{ color: '#175E63', fontSize: 14, fontWeight: '700' }}>AOM service fee (10%, max ₦15,000)</Text><Text style={{ color: '#175E63', fontSize: 14, fontWeight: '800' }}>₦ {serviceFee.toLocaleString('en-NG')}</Text></View>}
