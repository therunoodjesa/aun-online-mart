...
const styles = StyleSheet.create({
  ...
  pageHead: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: 14, marginBottom: 27 },
  twoColumn: { flexDirection: 'row', flexWrap: 'wrap', gap: 18, alignItems: 'flex-start' },
  panel: { flexGrow: 1, flexBasis: 330, borderWidth: 1, borderColor: '#DFE5EA', borderRadius: 15, padding: 20, minHeight: 240 },
  summaryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 18 },
  tabs: { flexDirection: 'row', flexWrap: 'wrap', gap: 18, borderBottomWidth: 1, borderBottomColor: '#DFE5EA', marginBottom: 15 },
  fieldPair: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  choiceEditorRow: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 7, marginTop: 7 },
  scheduleForm: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-end', gap: 10, maxWidth: 620 },
});
